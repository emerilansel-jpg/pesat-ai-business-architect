      ...
      <div className="max-w-[900px] mx-auto h-full flex items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-[#CBD5E1]">AI Business Architect</span>
          </div>

          <div className="hidden sm:block w-px h-5 bg-[#232A45]" />
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs font-medium text-[#64748B]">Online</span>
          </div>
